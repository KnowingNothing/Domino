...
def get_conv_chain_no_fuse_dataflow(levels, batch, height, width, in_channel, out_channel_1, out_channel_2, define_tiling_space=True, layout="nhwc", second_kernel_size=3):
    def static_func(ctx):
