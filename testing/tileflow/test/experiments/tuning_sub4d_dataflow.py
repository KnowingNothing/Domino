...
def sub4d_compute(ctx, tQ, tK, batch, num_heads, seq_len, hidden, levels):
    """
    ...
    tC = ops.sub4D(ctx, tQ, tK, loop_b, loop_h, loop_m,
    ...
    for ep in tqdm(range(epoch)):
        ...
        for i in range(steps):
            ...
            candidate = generate_candidate(
                space, static_sub4d, [batch, num_heads, seq_len, hidden])
