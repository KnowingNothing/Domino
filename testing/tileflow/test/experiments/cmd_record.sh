...
python conv_dataflow_l1_bw_profile.py --dataflow tangram --number 1 --inference --logfile data-tangram-nchw-random-tune-latency-2023-4-24/trace-new.log --layout nchw --inference --inference_hw 0 --second_kernel_size 1 --l1_bw 1 --define_tiling_space --metric L1::SlowDown --begin 0



python conv_dataflow_l2_bw_profile.py --dataflow tangram --number 1 --inference --logfile data-tangram-nchw-random-tune-latency-2023-4-24/trace-new.log --layout nchw --inference --inference_hw 0 --second_kernel_size 1 --l1_bw 450 --l2_bw 1 --define_tiling_space --metric L2::SlowDown --begin 0
